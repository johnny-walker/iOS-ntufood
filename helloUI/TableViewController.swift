...
//  helloUI
//
//  Created by albert on 2021/8/18.
...
class TableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        parseCSV(fileName:"ntufoods", fileType: "csv")
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.nameLabel?.text =  records[indexPath.row][0]
        cell.locationLabel?.text = records[indexPath.row][2]
        cell.typeLabel?.text = records[indexPath.row][5]
        cell.thumbnailView?.image = UIImage(named: records[indexPath.row][12])
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "showDetail" {
            if let indexPath = tableview.indexPathForSelectedRow {
                ...
                detailController.records = records
